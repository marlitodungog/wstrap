    ...
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
      ...
      <div class="nav-collapse">
        <ul class="nav pull-right">
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> wstrap.com <b class="caret"></b></a>
            <ul class="dropdown-menu">
          ...
          <div class="widget widget-nopad">
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                <div class="widget-content">
                  <h6 class="bigstats">A fully responsive premium quality admin template built on Twitter Bootstrap by <a href="#" target="_blank">wstrap.com</a>.  These are some dummy lines to fill the area.</h6>
...
<div class="footer">
  <div class="footer-inner">
    <div class="container">
      <div class="row">
        <div class="span12"> &copy; 2015 <a href="#">Wap Admin</a>. </div>
        <!-- /span12 --> 
      </div>
      <!-- /row --> 
    </div>
