...
<div class="dropdown pull-right" style="margin:-50px 14px 0 0">
    ...
    <ul class="dropdown-menu" role="menu" aria-labelledby="drpdwn">
        <li role="presentation"><?= $this->Html->link('<i class="fa fa-plus"></i> Add User',['action' => 'add'], ['escape' => false]) ?></li>
        <li role="presentation"><?= $this->Html->link('<i class="fa fa-list-alt"></i> List Group',['controller' => 'groups', 'action' => 'index'], ['escape' => false]) ?></li>
    </ul>
</div>
